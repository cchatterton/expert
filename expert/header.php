...
<a href="<?php echo esc_url( get_home_url( get_main_site_id(), '/' ) ); ?>"><?php esc_html_e( 'Agent directory', 'expert' ); ?></a>
	<?php if ( expert_is_agent() ) : ?>
<a href="<?php echo esc_url( get_post_type_archive_link( 'expert_source' ) ); ?>"><?php esc_html_e( 'Sources', 'expert' ); ?></a><a href="<?php echo esc_url( get_post_type_archive_link( 'expert_faq' ) ); ?>"><?php esc_html_e( 'FAQs', 'expert' ); ?></a><a href="<?php echo esc_url( get_post_type_archive_link( 'expert_research' ) ); ?>"><?php esc_html_e( 'Open questions', 'expert' ); ?></a><a href="<?php echo esc_url( add_query_arg( 'expert_view', 'timeline', home_url( '/' ) ) ); ?>"><?php esc_html_e( 'Timeline', 'expert' ); ?></a>
<?php endif; ?>
	<?php
