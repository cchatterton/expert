...
<div class="expert-local-ai" data-expert-local-ai><div><strong><?php esc_html_e( 'Private local AI', 'expert' ); ?></strong><p><?php esc_html_e( 'With your permission, this tab uses your device to answer and process short learning jobs. The model is cached in your browser; durable Agent memory stays in WordPress.', 'expert' ); ?></p></div><button type="button" data-expert-enable-ai><?php esc_html_e( 'Enable local AI', 'expert' ); ?></button><button type="button" class="expert-secondary" data-expert-disable-ai hidden><?php esc_html_e( 'Pause local AI', 'expert' ); ?></button><p class="expert-local-status" role="status" aria-live="polite"><?php esc_html_e( 'Local AI is off on this device.', 'expert' ); ?></p></div>
